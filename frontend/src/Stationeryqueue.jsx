    ...
    const [orders, setOrders] = useState([
        {
          _id: "1",
          studentId: "student1",
          itemsOrdered: ["2 Notebooks", "1 Pen"],
        ...
        },
        {
          _id: "2",
          studentId: "student2",
          itemsOrdered: ["3 Pencils", "1 Eraser"],
              ...
              <TableBody>
                {filteredOrders.map((order) => (
                  <TableRow key={order._id} hover>
                    ...
                    <TableCell>{order.itemsOrdered.join(", ")}</TableCell>
